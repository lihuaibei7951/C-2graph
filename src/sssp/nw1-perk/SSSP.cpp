...
string dir = "/home/lhb/compress1/com1/CompressGraph/dataset/cnr-2000/filter";
Graph graph(dir);
...
void *SSSP_CPU(void *data) {
	    // 2. 打开文件，如果文件不存在则创建；ios::app 表示追加模式
//outputFile.open("/home/lhb/compress1/com1/CompressGraph/sssp/sssp-n-w1-perk/output2.txt", std::ios::app);
