...
//const static size_t MAX_BLOCKS_NUM = 68 * (1536/THREADS_PER_BLOCK); // 80MP, 2048 threads/MP
const static size_t MAX_BLOCKS_NUM = 80 * (1536/THREADS_PER_BLOCK); // 80MP, 2048 threads/MP
