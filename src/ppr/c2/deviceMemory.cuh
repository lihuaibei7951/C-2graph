...
private:
    ...
    void CudaMallocData() {
        ...
        CUDA_ERROR(cudaMalloc(&pagerankStream, sizeof(ValueType) * vaddr ));
        CUDA_ERROR(cudaMalloc(&residualStream, sizeof(ValueType) * vaddr ));
        CUDA_ERROR(cudaMalloc(&messagesStream, sizeof(ValueType) * vaddr ));
